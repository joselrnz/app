...
export default async function KubernetesPage() {
  // Automatically get all kubernetes articles from markdown files
  const articles = getAllMarkdownFiles('kubernetes')
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-32">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              Master Kubernetes administration, container orchestration, and prepare for the Certified Kubernetes Administrator (CKA) exam.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {articles.map((article, index) => {
              ...
              const filename = article.slug.includes('/')
          ...
          <div className="mt-16 text-center">
            <p className="text-gray-400">More Kubernetes content and CKA prep materials coming soon...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-950 to-black">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to master Kubernetes?</h2>
          <p className="text-xl text-gray-300 mb-12">
            Start your journey to becoming a Certified Kubernetes Administrator.
          </p>
