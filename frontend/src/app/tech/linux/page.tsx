...
export default async function LinuxPage() {
  // Automatically get all Linux articles from markdown files
  const articles = getAllMarkdownFiles('linux')
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-32">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              Linux system administration, IoT platforms, embedded systems, and automation guides.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-gray-400">More Linux and IoT guides coming soon...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-950 to-black">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Need Linux expertise?</h2>
          <p className="text-xl text-gray-300 mb-12">
            Let's discuss your Linux, IoT, or embedded systems project.
          </p>
