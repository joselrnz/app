...
export default async function NotesPage() {
  // Automatically get all notes from markdown files
  const articles = getAllMarkdownFiles('notes')
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-16">
        <TechNavigation currentCategory="notes" />
      </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-32">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              Quick tips, troubleshooting guides, code snippets, and technical references.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {articles.map((article, index) => (
              <Link key={index} href={`/tech/notes/${article.slug}`} className="button-border-light group p-8 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300">
          ...
          <div className="mt-16 text-center">
            <p className="text-gray-400">More technical notes coming soon...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-950 to-black">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Have a question?</h2>
          <p className="text-xl text-gray-300 mb-12">Feel free to reach out for technical discussions.</p>
